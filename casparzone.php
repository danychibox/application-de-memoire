...
<body>
	...
	<div class="row">
		...
		<center><h2>cas par zone de santé</h2></center>
		<form method="POST" action="casparzone.php" name="valider">
		...
		if(isset($_POST['valider'])){
			$zone=$_POST['zone'];
			$connexion=mysqli_connect("localhost","chibox","chibox","bd_memoire");
			$requete="select * from structure,zonedesante,maladie,casmaladie where structure.designationZone=zonedesante.id_zone and casmaladie.structure=structure.id_structure and id_zone='$zone'";
